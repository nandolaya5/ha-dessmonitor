...
### Fixed
- Sensors now retain last known value when API sync fails instead of showing unavailable.
...
### Fixed
- Energy flow sensors now have correct units (% for SOC, W/kW for power).
- Removed queryPlants API calls that don't exist in ValueClouds API.

## [2.3.7] - 2026-07-15

### Fixed
- Syntax error in type hints that broke startup on Python 3.14 (HA 2025.x).
